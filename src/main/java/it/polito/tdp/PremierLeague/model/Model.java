...
public class Model {
	...
	//a prescindere che i vertici siano filtrati o meno --> riempo mappa
	//con tutti i possibili vertici e poi uso la mappa per estrarre il
	//sottoinsieme se sono vertici filtrati
	...
	public void creaGrafo(Match m) {
		...
		for(Adiacenza a : dao.getAdiacenze(m, idMap)) {
			if(a.getPeso() >= 0) { //p1 meglio di p2
	...
	public GiocatoreMigliore getMigliore() {
		...
		Player best = null;
		Double maxDelta = (double)Integer.MIN_VALUE; //anche 0 o -1, basta esser
		//sicuro che questo valore sia il più piccolo dei valori che incontrerò
		//nella ricerca del migliore
